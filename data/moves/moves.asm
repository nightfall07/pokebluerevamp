...
; Characteristics of each move.
	...
	move DOUBLESLAP,   TWO_TO_FIVE_ATTACKS_EFFECT,  20, NORMAL,        90, 20
	move COMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  30, FIGHTING,      95, 15
	...
	move BIND,         TRAPPING_EFFECT,             25, NORMAL,        75, 20
	move SLAM,         FLINCH_SIDE_EFFECT1,         80, NORMAL,        85, 15
	move VINE_WHIP,    NO_ADDITIONAL_EFFECT,        35, GRASS,        100, 25
	move STOMP,        FLINCH_SIDE_EFFECT2,         65, NORMAL,       100, 20
	move DOUBLE_KICK,  ATTACK_TWICE_EFFECT,         30, FIGHTING,     100, 30
	move MEGA_KICK,    NO_ADDITIONAL_EFFECT,       120, NORMAL,        75, 10
	move JUMP_KICK,    JUMP_KICK_EFFECT,            85, FIGHTING,      95, 15
	move ROLLING_KICK, FLINCH_SIDE_EFFECT2,         65, FIGHTING,      85, 20
	move SAND_ATTACK,  ACCURACY_DOWN1_EFFECT,        0, BIRD,         100, 20
	move HEADBUTT,     FLINCH_SIDE_EFFECT2,         70, NORMAL,       100, 15
	move HORN_ATTACK,  NO_ADDITIONAL_EFFECT,        65, NORMAL,       100, 25
	move FURY_ATTACK,  TWO_TO_FIVE_ATTACKS_EFFECT,  20, NORMAL,        90, 20
	move HORN_DRILL,   OHKO_EFFECT,                  1, NORMAL,        30,  5
	move TACKLE,       NO_ADDITIONAL_EFFECT,        35, NORMAL,        95, 35
	move BODY_SLAM,    PARALYZE_SIDE_EFFECT2,       85, NORMAL,       100, 10
	move WRAP,         TRAPPING_EFFECT,             20, NORMAL,        85, 20
	move TAKE_DOWN,    RECOIL_EFFECT,               90, NORMAL,        85, 20
	move THRASH,       THRASH_PETAL_DANCE_EFFECT,  100, NORMAL,       100, 10
	move DOUBLE_EDGE,  RECOIL_EFFECT,              120, NORMAL,       100,  5
	...
	move PIN_MISSILE,  TWO_TO_FIVE_ATTACKS_EFFECT,  30, BUG,           95, 15
	...
	move FLAMETHROWER, BURN_SIDE_EFFECT1,           90, FIRE,         100, 10
	move MIST,         MIST_EFFECT,                  0, BIRD,         100, 30
	...
	move SUBMISSION,   RECOIL_EFFECT,              100, FIGHTING,      90, 10
	move LOW_KICK,     FLINCH_SIDE_EFFECT1,         50, FIGHTING,     100, 25
	move COUNTER,      NO_ADDITIONAL_EFFECT,         1, FIGHTING,     100, 20
	move SEISMIC_TOSS, SPECIAL_DAMAGE_EFFECT,        1, FIGHTING,     100, 20
	move STRENGTH,     NO_ADDITIONAL_EFFECT,        70, NORMAL,       100, 20
	move ABSORB,       DRAIN_HP_EFFECT,             30, GRASS,        100, 25
	move MEGA_DRAIN,   DRAIN_HP_EFFECT,             70, GRASS,        100, 15
	move LEECH_SEED,   LEECH_SEED_EFFECT,            0, BIRD,          90, 10
	move GROWTH,       SPECIAL_UP1_EFFECT,           0, BIRD,         100, 40
	move RAZOR_LEAF,   NO_ADDITIONAL_EFFECT,        55, GRASS,         95, 25
	move SOLARBEAM,    CHARGE_EFFECT,              150, GRASS,        100,  5
	move POISONPOWDER, POISON_EFFECT,                0, BIRD,          85, 25
	move STUN_SPORE,   PARALYZE_EFFECT,              0, BIRD,          80, 20
	move SLEEP_POWDER, SLEEP_EFFECT,                 0, BIRD,          75, 15
	move PETAL_DANCE,  THRASH_PETAL_DANCE_EFFECT,  100, GRASS,        100, 10
	move STRING_SHOT,  SPEED_DOWN1_EFFECT,           0, BIRD,          95, 40
	move DRAGON_RAGE,  PARALYZE_SIDE_EFFECT2,       80, DRAGON,       100, 15
	move FIRE_SPIN,    TRAPPING_EFFECT,             25, FIRE,          70, 15
	move THUNDERSHOCK, PARALYZE_SIDE_EFFECT1,       40, ELECTRIC,     100, 30
	move THUNDERBOLT,  PARALYZE_SIDE_EFFECT1,       90, ELECTRIC,     100, 10
	move THUNDER_WAVE, PARALYZE_EFFECT,              0, ELECTRIC,      90, 20
	move THUNDER,      PARALYZE_SIDE_EFFECT2,      120, ELECTRIC,      75,  5
	...
	move TOXIC,        POISON_EFFECT,                0, BIRD,          90, 10
	...
	move HYPNOSIS,     SLEEP_EFFECT,                 0, BIRD,          60, 20
	...
	move TELEPORT,     SWITCH_AND_TELEPORT_EFFECT,   0, BIRD,         100, 20
	move NIGHT_SHADE,  SPECIAL_DOWN_SIDE_EFFECT,    70, GHOST,        100, 15
	move MIMIC,        MIMIC_EFFECT,                 0, BIRD,         100, 10
	move SCREECH,      DEFENSE_DOWN2_EFFECT,         0, BIRD,          85, 20
	...
	move CONFUSE_RAY,  CONFUSION_EFFECT,             0, BIRD,         100, 10
	...
	move EGG_BOMB,     NO_ADDITIONAL_EFFECT,       100, NORMAL,       100, 10
	...
	move BONE_CLUB,    FLINCH_SIDE_EFFECT1,         50, GROUND,        95, 25
	...
	move GLARE,        PARALYZE_EFFECT,              0, BIRD,         100, 20
	move DREAM_EATER,  DREAM_EATER_EFFECT,         100, PSYCHIC_TYPE, 100, 10
	move POISON_GAS,   POISON_EFFECT,                0, BIRD,          90, 40
	move BARRAGE,      TWO_TO_FIVE_ATTACKS_EFFECT,  30, GRASS,         95, 15
	...
	move DIZZY_PUNCH,  CONFUSION_SIDE_EFFECT,       85, NORMAL,       100, 15
	move SPORE,        SLEEP_EFFECT,                 0, BIRD,         100, 15
	...
	move BONEMERANG,   ATTACK_TWICE_EFFECT,         65, GROUND,        90, 10
	move REST,         HEAL_EFFECT,                  0, BIRD,         100,  5
	move ROCK_SLIDE,   FLINCH_SIDE_EFFECT2,         75, ROCK,          95, 15
